...
[^1]: These operators are "binary operators," which compare values (R Documentation, Comparison). See `?Comparison` for more information. For logic operators, see `?Logic`.
...
summ_dm <- data.frame(Function    = c('replace(x, condition, replacement)',
                      ...
                      Description = c("Replace a value in a vector based on a condition.",
                                      ...
                                      'Iteratively call a function on a list',
...
summ_libs <- data.frame(Library = c('ggplot2',
                        ...
                        Function = c("ggplot(data) + aes(y, x, ...) + geom_point()",
                                     "select(data, ...), group_by(data, data...), summarise(data, ...)",
                                     "pivot_wider(data, ...), pivot_longer(data, ...)",
                                     "map(.x, .f)",
                                     "kable(x)",
                                     "stargazer(x)"),
